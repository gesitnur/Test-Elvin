...
Apartment.configure do |config|
  ...
  #
  config.excluded_models = %w[ User Company ContactRequest WebsiteSetting Position Country Currency State Survey Forum ForumCategory BugReport PaymentTerm]
...
Apartment::Elevators::Subdomain.excluded_subdomains = %w[admin interview www member membership plan subscription
                                                         cpanel status api ftp mail ssl]
# Rails.application.config.middleware.use 'Apartment::Elevators::Subdomain'
